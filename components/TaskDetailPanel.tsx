...
// FIX: Added Target to imports for the Processus source module.
import { X, Edit, Info, Clock, User, GitBranch, AlertTriangle, CheckCircle, Settings, FileText, Calendar, Target, AlertCircle } from 'lucide-react';
...
const SOURCE_ICONS: Record<Tache['sourceModule'], React.ElementType> = {
    ...
    'Incident': AlertTriangle, 'Amelioration': AlertTriangle, 'Actif': AlertCircle, 'NormesLois': FileText,
    // FIX: Added missing 'Processus' key to satisfy the TacheSourceModule type.
    'Processus': Target
};
