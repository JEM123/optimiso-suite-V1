...
const organisationCsvData = `Direction_Nom,Division_Nom_Liée a la Direction,Service_Nom liée a la Division,Nom_Section Liée au Service
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION ENTREPRISE,SERVICE INSTALLATION AUTOCOM,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION ENTREPRISE,SERVICE RÉSEAU D'ENTREPRISE,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION ENTREPRISE,SERVICE TERMINAUX,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION PRODUCTION,POLE PRODUCTION DJIBOUTI,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION PRODUCTION,POLE PRODUCTION BALBALA,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION PRODUCTION,SERVICE MESURES & IDENTIFICATION CÂBLES,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION PRODUCTION,SERVICE PARC AUTO,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION PRODUCTION,SERVICE GESTION DÉGÂTS RÉSEAUX,
DIRECTION DES INFRASTRUCTURES,CHEF DIVISION BUREAU ÉTUDES,SERVICE BUREAU ÉTUDES,"SECTION CONCEPTION SUD,SECTION CONCEPTION NORD,SECTION CONCEPTION BALBALA"
DIRECTION DES INFRASTRUCTURES,CHEF DIVISION BUREAU ÉTUDES,SERVICE POINT D'ENTRÉE UNIQUE & ÉTUDE CLIENT,SECTION ÉTUDE CLIENT
DIRECTION DES INFRASTRUCTURES,CHEF DIVISION BUREAU ÉTUDES,SERVICE DÉTECTION ET COORDINATION,SECTION GC
DIRECTION DES INFRASTRUCTURES,CHEF DIVISION BUREAU ÉTUDES,SERVICE APPRO ET SUIVI DES MATÉRIELS,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION TRANSMISSION,SERVICE BUREAU DE GESTION,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION TRANSMISSION,SERVICE BACKBONE FO,SECTION EXPLOITATION FO
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION TRANSMISSION,SERVICE BACKBONE FH,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION TRANSMISSION,SERVICE RÉSEAUX IP,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION TRANSMISSION,SERVICE O&M,"SECTION NOC,SECTION EXPLOITATION TERRAIN,SECTION SYNCHRONISATION"
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION TRANSMISSION,SERVICE FFTH,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION RÉGIONS,CHEF DE CENTRE ALI-SABIETH,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION RÉGIONS,CHEF DE CENTRE TADJOURAH,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION RÉGIONS,CHEF DE CENTRE DIKHIL,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION RÉGIONS,CHEF DE CENTRE OBOCK,
DIRECTION DES INFRASTRUCTURES,CHEF DE DIVISION RÉGIONS,CHEF DE CENTRE ARTA,
DIRECTION DES INFRASTRUCTURES,CHEF DE CENTRE DE TRANSMISSION SATELLITAIRE,CHEF DE SERVICE VT,"SECTION CONTRÔLE & VALIDATION,SECTION ANALYSE QUALITÉ RÉSEAUX,SECTION POINT ÉCOLE"
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE BASE STATION SUBSYSTEM,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE MOBILE SWITCHING CENTER,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE HOME LOCATION REGISTER,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE MOBIL GATEWAY,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE CHARGING SYSTÈME,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE MEDIATION,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE PACKET CORE SYSTEM,
DIRECTION DES RÉSEAUX MOBILES,DIVISION IP & CŒUR DE RÉSEAUX,SERVICE VOIP SOFTSWITCH,
DIRECTION DES RÉSEAUX MOBILES,DIVISION INGÉNIERIE RADIO,SERVICE RAN MANAGEMENT,
DIRECTION DES RÉSEAUX MOBILES,DIVISION INGÉNIERIE RADIO,SERVICE PLANIFICATION RF,
DIRECTION DES RÉSEAUX MOBILES,DIVISION INGÉNIERIE RADIO,SERVICE RF OPTIMIZATION,
DIRECTION DES RÉSEAUX MOBILES,DIVISION INGÉNIERIE RADIO,SERVICE NETWORK INTEGRATION & COMMISSIONING,
DIRECTION DES RÉSEAUX MOBILES,DIVISION INGÉNIERIE RADIO,SERVICE RADIO ACCESS NETWORK,
DIRECTION DES RÉSEAUX MOBILES,DIVISION ROAMING & VAS,SERVICE ROAMING,
DIRECTION DES RÉSEAUX MOBILES,DIVISION ROAMING & VAS,SERVICE VALUE ADDED SERVICES,
DIRECTION DES RÉSEAUX MOBILES,DIVISION ROAMING & VAS,SERVICE REVENUE ASSURANCE,
DIRECTION DES RÉSEAUX MOBILES,DIVISION EXPLOITATION & SUPERVISION RADIO,SERVICE NETWORK OPERATION CENTER,
DIRECTION DES RÉSEAUX MOBILES,DIVISION EXPLOITATION & SUPERVISION RADIO,SERVICE FIELD OPERATION,
DIRECTION DES RÉSEAUX MOBILES,DIVISION EXPLOITATION & SUPERVISION RADIO,SERVICE SITE ACQUISITION,
DIRECTION DES RÉSEAUX MOBILES,DIVISION EXPLOITATION & SUPERVISION RADIO,SERVICE PREVENTIVE MAINTENANCE,
DIRECTION DES SYSTÈMES D'INFORMATION,PÔLE PROJET ET INNOVATION,SERVICE BSS STUDY & DEVELOPMENT,
DIRECTION DES SYSTÈMES D'INFORMATION,PÔLE PROJET ET INNOVATION,SERVICE APPLICATIONS DEVELOPMENT,
DIRECTION DES SYSTÈMES D'INFORMATION,PÔLE PROJET ET INNOVATION,SERVICE BUSINESS INTELLIGENCE,
DIRECTION DES SYSTÈMES D'INFORMATION,PÔLE PROJET ET INNOVATION,SERVICE STUDY & INNOVATION,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION OPÉRATION SI,SERVICE DATACENTER,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION OPÉRATION SI,SERVICE SYSTEM ADMINISTRATION,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION OPÉRATION SI,SERVICE DATABASE ADMINISTRATION,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION OPÉRATION SI,SERVICE NETWORK ADMINISTRATION,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION OPÉRATION SI,SERVICE SYSTEM MONITORING,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION OPÉRATION SI,SERVICE CYBERSECURITY,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION PLATEFORME DE SERVICE & OSS,SERVICE BILLING SYSTÈME,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION PLATEFORME DE SERVICE & OSS,SERVICE CRM,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION PLATEFORME DE SERVICE & OSS,SERVICE OSS,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION PLATEFORME DE SERVICE & OSS,SERVICE PROVISIONING,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION PLATEFORME DE SERVICE & OSS,SERVICE MIDDLEWARE,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION INFRASTRUCTURE NUMÉRIQUE,SERVICE DIGITAL INFRASTRUCTURE,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION INFRASTRUCTURE NUMÉRIQUE,SERVICE CLOUD & VIRTUALIZATION,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION INFRASTRUCTURE NUMÉRIQUE,SERVICE IT NETWORKS,
DIRECTION DES SYSTÈMES D'INFORMATION,DIVISION INFRASTRUCTURE NUMÉRIQUE,SERVICE HELP DESK,
DIRECTION D-MONEY,DIVISION OPÉRATION ET SERVICE CLIENTS ET PARTENAIRES,SERVICE CUSTOMER CARE,
DIRECTION D-MONEY,DIVISION OPÉRATION ET SERVICE CLIENTS ET PARTENAIRES,SERVICE PARTNER MANAGEMENT,
DIRECTION D-MONEY,DIVISION OPÉRATION ET SERVICE CLIENTS ET PARTENAIRES,SERVICE AGENT NETWORK,
DIRECTION D-MONEY,DIVISION OPÉRATION ET SERVICE CLIENTS ET PARTENAIRES,SERVICE MERCHANT ACQUISITION,
DIRECTION D-MONEY,DIVISION MARKETING COMMERCIAL ET COMMUNICATION,SERVICE MARKETING D-MONEY,
DIRECTION D-MONEY,DIVISION MARKETING COMMERCIAL ET COMMUNICATION,SERVICE COMMERCIAL D-MONEY,
DIRECTION D-MONEY,DIVISION MARKETING COMMERCIAL ET COMMUNICATION,SERVICE COMMUNICATION D-MONEY,
DIRECTION D-MONEY,DIVISION MARKETING COMMERCIAL ET COMMUNICATION,SERVICE PRODUCT MANAGEMENT,
DIRECTION D-MONEY,DIVISION IT,SERVICE IT DEVELOPMENT,
DIRECTION D-MONEY,DIVISION IT,SERVICE IT OPERATIONS,
DIRECTION D-MONEY,DIVISION IT,SERVICE IT SECURITY,
DIRECTION D-MONEY,DIVISION IT,SERVICE SYSTEM INTEGRATION,
DIRECTION D-MONEY,DIVISION CONFORMITÉ CONTRÔLE INTERNE RISQUE FRAUDE ET JURIDIQUE,SERVICE COMPLIANCE,
DIRECTION D-MONEY,DIVISION CONFORMITÉ CONTRÔLE INTERNE RISQUE FRAUDE ET JURIDIQUE,SERVICE RISK MANAGEMENT,
DIRECTION D-MONEY,DIVISION CONFORMITÉ CONTRÔLE INTERNE RISQUE FRAUDE ET JURIDIQUE,SERVICE FRAUD PREVENTION,
DIRECTION D-MONEY,DIVISION CONFORMITÉ CONTRÔLE INTERNE RISQUE FRAUDE ET JURIDIQUE,SERVICE LEGAL AFFAIRS,
DIRECTION D-MONEY,DIVISION FINANCIÈRE ADMINISTRATIVE ET SUPPORT,SERVICE FINANCE D-MONEY,
DIRECTION D-MONEY,DIVISION FINANCIÈRE ADMINISTRATIVE ET SUPPORT,SERVICE ADMINISTRATION D-MONEY,
DIRECTION D-MONEY,DIVISION FINANCIÈRE ADMINISTRATIVE ET SUPPORT,SERVICE LOGISTICS D-MONEY,
DIRECTION D-MONEY,DIVISION FINANCIÈRE ADMINISTRATIVE ET SUPPORT,SERVICE HR D-MONEY,
DIRECTION JURIDIQUE COMMUNICATION ET RELATIONS PUBLIQUES,DJCRP-PAS DE DIVISION,SERVICE JURIDIQUE,
DIRECTION JURIDIQUE COMMUNICATION ET RELATIONS PUBLIQUES,DJCRP-PAS DE DIVISION,SERVICE COMMUNICATION,
DIRECTION JURIDIQUE COMMUNICATION ET RELATIONS PUBLIQUES,DJCRP-PAS DE DIVISION,SERVICE RELATIONS PUBLIQUES,
DÉPARTEMENT GESTION DU PATRIMOINE,DGP-PAS DE DIVISION,SERVICE GESTION PATRIMOINE,
DIRECTION BUSINESS INTERNATIONAL,DIVISION COMMERCIAL DATA,SERVICE DATA INTERNATIONAL,
DIRECTION BUSINESS INTERNATIONAL,DIVISION COMMERCIAL DATA,SERVICE BUSINESS DEVELOPMENT,
DIRECTION BUSINESS INTERNATIONAL,DIVISION COMMERCIAL ROAMING ET VOIX,SERVICE ROAMING INTERNATIONAL,
DIRECTION BUSINESS INTERNATIONAL,DIVISION COMMERCIAL ROAMING ET VOIX,SERVICE VOICE INTERNATIONAL,
DIRECTION BUSINESS INTERNATIONAL,DIVISION EXPLOITATION INFRASTRUCTURE CÂBLE YAC,SERVICE YAC OPERATIONS,
DIRECTION BUSINESS INTERNATIONAL,DIVISION EXPLOITATION INFRASTRUCTURE CÂBLE YAC,SERVICE YAC MAINTENANCE,
DIRECTION BUSINESS INTERNATIONAL,DIVISION EXPLOITATION INFRASTRUCTURE CÂBLE HARAMOUS,SERVICE HARAMOUS OPERATIONS,
DIRECTION BUSINESS INTERNATIONAL,DIVISION EXPLOITATION INFRASTRUCTURE CÂBLE HARAMOUS,SERVICE HARAMOUS MAINTENANCE,
DIRECTION DE LA PLANIFICATION DES PERFORMANCES ET CONTRÔLE FINANCIER,DIVISION CONTRÔLE ET GESTION,SERVICE CONTRÔLE GESTION,
DIRECTION DE LA PLANIFICATION DES PERFORMANCES ET CONTRÔLE FINANCIER,DIVISION CONTRÔLE ET GESTION,SERVICE PLANIFICATION,
DIRECTION DE LA PLANIFICATION DES PERFORMANCES ET CONTRÔLE FINANCIER,DIVISION REVENU ASSURANCE ET FRAUDE MANAGEMENT,SERVICE REVENUE ASSURANCE GENERAL,
DIRECTION DE LA PLANIFICATION DES PERFORMANCES ET CONTRÔLE FINANCIER,DIVISION REVENU ASSURANCE ET FRAUDE MANAGEMENT,SERVICE FRAUD MANAGEMENT,
DIRECTION AUDIT INSPECTION CONTRÔLES,DAIC-PAS DE DIVISION,SERVICE AUDIT INTERNE,
DIRECTION AUDIT INSPECTION CONTRÔLES,DAIC-PAS DE DIVISION,SERVICE INSPECTION,
DIRECTION AUDIT INSPECTION CONTRÔLES,DAIC-PAS DE DIVISION,SERVICE CONTRÔLES,
DÉPARTEMENT RADIO,DR-PAS DE DIVISION,SERVICE RADIO TECHNIQUE,
DÉPARTEMENT RADIO,DR-PAS DE DIVISION,SERVICE RADIO DIFFUSION,
DÉPARTEMENT SUPPORT CLIENT,DSC-PAS DE DIVISION,SERVICE SUPPORT CLIENT ENTREPRISE,
DÉPARTEMENT SUPPORT CLIENT,DSC-PAS DE DIVISION,SERVICE SUPPORT CLIENT PARTICULIER,
DIRECTION ADMINISTRATIVE,DA-PAS DE DIVISION,SERVICE ADMINISTRATION GENERALE,
DIRECTION ADMINISTRATIVE,DA-PAS DE DIVISION,SERVICE RESSOURCES HUMAINES,
DIRECTION ADMINISTRATIVE,DA-PAS DE DIVISION,SERVICE SECRETARIAT,
DIRECTION COMMERCIALE,DC-PAS DE DIVISION,SERVICE COMMERCIAL ENTREPRISE,
DIRECTION COMMERCIALE,DC-PAS DE DIVISION,SERVICE COMMERCIAL PARTICULIER,
DIRECTION COMMERCIALE,DC-PAS DE DIVISION,SERVICE VENTE,
DÉPARTEMENT ACHAT LOGISTIQUE,DAL-PAS DE DIVISION,SERVICE ACHAT,
DÉPARTEMENT ACHAT LOGISTIQUE,DAL-PAS DE DIVISION,SERVICE LOGISTIQUE,
DÉPARTEMENT ACHAT LOGISTIQUE,DAL-PAS DE DIVISION,SERVICE APPROVISIONNEMENT,
DÉPARTEMENT ÉNERGIE,DE-PAS DE DIVISON,SERVICE ENERGIE ELECTRIQUE,
DÉPARTEMENT ÉNERGIE,DE-PAS DE DIVISON,SERVICE MAINTENANCE ENERGIE,
DIRECTION AGENCE COMPTABLE,DAC-PAS DE DIVISION,SERVICE AGENCE COMPTABLE,
DIRECTION AGENCE COMPTABLE,DAC-PAS DE DIVISION,SERVICE COMPTABILITE,
DIRECTION GLOBAL SOLUTION,DGS-PAS DE DIVISION,SERVICE GLOBAL SOLUTION ENTREPRISE,
DIRECTION GLOBAL SOLUTION,DGS-PAS DE DIVISION,SERVICE GLOBAL SOLUTION GOUVERNEMENT,
DIRECTION RÉSEAU FIXE,DRF-PAS DE DIVISION,SERVICE RESEAU FIXE URBAIN,
DIRECTION RÉSEAU FIXE,DRF-PAS DE DIVISION,SERVICE RESEAU FIXE REGIONAL,
DIRECTION RÉSEAU FIXE,DRF-PAS DE DIVISION,SERVICE MAINTENANCE FIXE,
DJIBOUTI GÉNÉRAL,DG-PAS DE DIVISON,SERVICE DIRECTION GENERALE,
DJIBOUTI GÉNÉRAL,DG-PAS DE DIVISON,SERVICE CABINET DG,
DJIBOUTI GÉNÉRAL,DG-PAS DE DIVISON,SERVICE CONSEIL DG,
DJIBOUTI GÉNÉRAL,DG-PAS DE DIVISON,SERVICE SECRETARIAT DG,
DJIBOUTI GÉNÉRAL,DG-PAS DE DIVISON,SERVICE PROTOCOLE,
DJIBOUTI GÉNÉRAL,DG-PAS DE DIVISON,SERVICE CHAUFFEURS,`;

function generateEntitesFromCsv(csvData: string): Entite[] {
  const entites: Entite[] = [];
  const nameToIdMap = new Map<string, string>(); // Key: "parent_id-entity_name", Value: "entity_id"

  const { data } = Papa.parse(csvData.trim(), { header: true, skipEmptyLines: true });

  for (const row of data as any[]) {
    let parentId: string | undefined = undefined;
    let ordreCounter = 1;

    const createOrGetEntity = (
        name: string, 
        type: Entite['type'], 
        currentParentId: string | undefined
    ): string | undefined => {
        if (!name || name.trim() === '') return currentParentId;
        
        const trimmedName = name.trim();
        const key = `${currentParentId || 'root'}-${trimmedName}`;
        ...
        const code = (words.length > 1 ? words.map(w => w[0]).join('') : trimmedName.substring(0, 3)).toUpperCase();

        const newEntity: Entite = {
            id: newId,
            reference: code,
            nom: trimmedName,
            code: code,
        ...
        nameToIdMap.set(key, newId);
        return newId;
    };

    // Process Hierarchy
    const dirName = row["Direction_Nom"];
    const dirId = createOrGetEntity(dirName, 'Direction', undefined);
    parentId = dirId;

    const divName = row["Division_Nom_Liée a la Direction"];
    if (divName && !divName.includes('-PAS DE DIVI')) { // Handle cases like 'DAIC-PAS DE DIVISION'
        const divId = createOrGetEntity(divName, 'Division', parentId);
        parentId = divId;
    }

    const srvName = row["Service_Nom liée a la Division"];
    const srvId = createOrGetEntity(srvName, 'Service', parentId);
    parentId = srvId;

    const secNames = row["Nom_Section Liée au Service"];
    if (secNames && secNames.trim() !== '') {
        const sections = secNames.split(',');
        for (const secName of sections) {
            createOrGetEntity(secName, 'Équipe', parentId); // Mapping 'Section' to 'Équipe'
        }
    }
  }
...
export const mockData = {
  ...
  entites: generateEntitesFromCsv(organisationCsvData),
